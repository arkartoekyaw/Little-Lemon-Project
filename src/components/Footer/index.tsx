...
const Footer: FC<HTMLAttributes<HTMLElement>> = (props): JSX.Element => {
  return (
    <Container {...props}>
        ...
        <Column>
          ...
          <ul>
            <li>
              {" "}
              <a
                href="https://www.facebook.com/arkartoekyaw"
                target="_blank"
                rel="external"
              >
                Facebook
            ...
            <li>
              {" "}
              <a
                href="https://www.instagram.com/arkartoekyaw"
                target="_blank"
                rel="external"
              >
                Instagram
            ...
            <li>
              {" "}
              <a
                href="https://twitter.com/arkartoekyaw"
                target="_blank"
                rel="external"
              >
                Twitter
      ...
      <Copyright>
        <span>Developed by R Kar Toe Kyaw.</span>
